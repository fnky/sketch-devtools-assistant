...
NSString *const kPluginFolderPathNormal = @"~/Library/Application Support/com.bohemiancoding.sketch3/Plugins/";
NSString *const kExchangeFileName = @"sdt-exchange.json";
