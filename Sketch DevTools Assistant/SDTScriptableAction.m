...
-(BOOL)compare:(SDTScriptableAction*)other {
  return [self.actionID isEqualToString:other.actionID]
    && [self.name isEqualToString:other.name]
    && [self.scriptFilePath isEqualToString:other.scriptFilePath]
    && [self.scriptSource isEqualToString:other.scriptSource]
