...
- (id)performDefaultImplementation {
  ...
  if ([[NSFileManager defaultManager] fileExistsAtPath:filePath]) {
    ...
    if (data) {
      ...
      NSString* newFileName = [NSString stringWithFormat:@"__%@_sketchdevtools__.js",
        [[filePath stringByDeletingPathExtension] lastPathComponent]];
    ...
    NSAlert* alert = [NSAlert alertWithMessageText:@"Error: Could not run script"
                                     defaultButton:@"Close"
                                   alternateButton:@""
                                       otherButton:nil
                         informativeTextWithFormat:@"The specified script file isn't exist:\n'%@'", filePath];
    [alert runModal];
  }
