...
- (void)getURL:(NSAppleEventDescriptor *)event withReplyEvent:(NSAppleEventDescriptor *)reply {
  ...
  if (url && [url.host isEqualToString:@"open"]) {
    ...
    if (params[@"url"]) {
      ...
      [SDTProtocolHandler openFile:[[NSURL URLWithString:params[@"url"]] path]
                           withIDE:schemeMap[url.scheme]
                            atLine:[params[@"line"] integerValue]];
    }
  }
}
...
- (void)workspaceDidLaunchApplicationNotification:(NSNotification*)notification {
  ...
  if (bundleID && ([bundleID isEqualToString:@"com.bohemiancoding.sketch3.beta"] ||
                  [bundleID isEqualToString:@"com.bohemiancoding.sketch3"])) {
